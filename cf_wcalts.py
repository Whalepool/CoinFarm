...
t = Twitter(auth=OAuth('xxxxxxx', 'zzzzzzzzzz', 'yyyyyyyyy', 'vvvvvvvvvvv'))

# fetch last update id from external file
f = open('/home/ubuntu/volume1/stakepool/teamspeakbots/lastwcaltsupdate.txt', encoding='utf-8')
...
# grab tl updates
updates=timeline=t.statuses.user_timeline(screen_name="whalecallsalts", count=30)
wclist=list()
...
for update in reversed(updates):
	...
	if (int(latestid) < int(tweetid)):
		...
		wclist.append(text)
		latestid=tweetid
		f = open('/home/ubuntu/volume1/stakepool/teamspeakbots/lastwcaltsupdate.txt', '+w', encoding='utf-8')
		f.write(latestid)
		f.close()
